    ...
    return(
        <>
            <div className="container">
                <div className="row">
                    <div className="col">
                        <div className="fs-1 fw-bolder">{info.rating} <span className="fs-5 fw-normal text-secondary"> / 5</span> </div>
                        <div className="fw-bolder">Overall Quality Based on {info.numOfRatings} ratings</div>
                        <div className="mt-3 wd-profname">{info.name} <span><i className="bi bi-bookmark text-secondary fw-bolder fs-4 ms-2"></i></span></div>
                        <div>Professor in the <span className="fw-bolder">{info.department} department</span> at <span className="fw-bolder"><Link to="https://www.northeastern.edu/" className="text-dark">Northeastern University</Link></span></div>
                        <div className="d-flex flex-row bd-highlight">
                            <div className="p-2 bd-highlight border-2 border-end border-dark">
                                <div className="ms-4 wd-data">{info.againPct}</div>
                                <div>Would take again</div>
                            </div>
                            <div className="p-2 bd-highlight">
                                <div className="ms-4 wd-data">{info.difficultyLevel}</div>
                                <div>Level of Difficulty</div>
                            </div>
                        </div>
                        <button onClick={()=><AddRating/>}
                            className="mt-3 btn btn-primary rounded-pill fw-bolder">
                            Rate Professor</button>
                        <div className="mt-2 d-flex flex-row bd-highlight">
                            <div className="p-2 bd-highlight border-1 border-end border-dark">
                                <Link to="#" className="text-dark">I'm the professor</Link>
                            </div>
                            <div className="p-2 bd-highlight">
                    ...
                    <div className="col">
                        <table className="table table-warning table-striped mt-5">
                            ...
                            <tr>
                                ...
                                <td>{info.numOfAwesome}</td>
                            </tr>
                            <tr>
                                <th scope="row">Great 4</th>
                                <td>{info.numOfGreat}</td>
                            </tr>
                            <tr>
                                <th scope="row">Good 3</th>
                                <td>{info.numOfGood}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>{info.numOfAwful}</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                </div>
                <div className="mt-4 fw-bolder wd-margin-center">{info.numOfRatings} Student Ratings</div>
