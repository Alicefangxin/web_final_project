  ...
  return (
    <div className="header">
      <div className="header-content">
        ...
        <div
          className={path === "/search" ? "header-item active" : "header-item"}
        >
          <Link to="/search">Search</Link>
        </div>
        <div
          className={
            path === "/userlist" ? "header-item active" : "header-item"
          }
        >
          <Link to="/userlist">UserList</Link>
        </div>
        <div
          className={path === "/profile" ? "header-item active" : "header-item"}
        >
        ...
        <div className="header-item login">
          ...
          {currentUser === null ? (
            <Link
              className={
                path === "/login" ? "header-item active" : "header-item"
              }
              to="/login"
            >
              log in
